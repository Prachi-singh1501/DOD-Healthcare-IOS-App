...
function GetProfile() {
    $.ajax({
        url: apiurl + "API/Patient/Profile?PatientId=" + detail.PatientId,
        type: "GET",
        success: function (data) {
            ...
            $(".profileImage").attr('src', ProfilePic);
                ...
                {
                    $("#StatesList").val(data.patient.City.StateId).attr('selected');
...
function UpdateProfile() {
    ...
    if (status == true) {
        ...
        console.log(profile)
        $.post(apiurl + "API/Patient/Profile", profile, function (data) {
            console.log(data)
...
var loadFile = function (event) {
    ...
    formData.append('PatientId', detail.PatientId);
    $.ajax({
        processData: false,
        contentType: false,
        url: "https://dev.dodind.com/patient/ProfilePicUpdateMobile",
        type: "POST",
        data: formData,
        datatype: "json",
        success: function (data) {
